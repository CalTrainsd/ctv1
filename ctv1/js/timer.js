...
var intv = {
	...
	defaultEvent: { 
		...
		msg:"<br>", msgColor:"black",
		html:{id:"intvClock",text:"<br>"}, clockColor:"black",
		img:""
		}, 
...
*/
		...
		if( intv.clockTicker ) {
			$("#intvClock").html( (--intv.clockTicker == 0) ? "<br>" : intv.clockTicker ) ;
			}
		// do events
		if( intv.eventTicker ) {
			intv.eventTicker--;
...
// pop init and close //////////////////
	popupbeforeposition: function() {
		// width
		$("#intvPopup").css('width', 0.8*$(window).width() ) ;
...
console.log( "--------page1:pageinit") ;
    $( "#intvPopup").on("popupafteropen", intv.popupafteropen );
    	...
    	$( "#intvPopup" ).on("popupbeforeposition", intv.popupbeforeposition );
	}
});
